...
export const TRADE_FLOWS = [
  ...
  { from: 'CHN', to: 'DEU', volume: 240, type: 'trade' },
  ...
  { from: 'IND', to: 'USA', volume: 95, type: 'trade' },
  { from: 'IND', to: 'ARE', volume: 80, type: 'trade' },
  { from: 'SAU', to: 'CHN', volume: 60, type: 'trade' },
  { from: 'SAU', to: 'IND', volume: 45, type: 'trade' },
  { from: 'BRA', to: 'ARG', volume: 30, type: 'trade' },
  { from: 'NGA', to: 'IND', volume: 15, type: 'trade' },
  { from: 'ZAF', to: 'CHN', volume: 20, type: 'trade' },
  { from: 'IDN', to: 'CHN', volume: 75, type: 'trade' },
  { from: 'THA', to: 'CHN', volume: 70, type: 'trade' },
  { from: 'RUS', to: 'CHN', volume: 100, type: 'trade' },
];
